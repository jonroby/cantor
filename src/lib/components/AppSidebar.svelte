...
<Sidebar.Root collapsible="icon">
	<Sidebar.Header class="p-0">
		...
		>
			{#if sidebar.state === 'collapsed'}
				...
				<button
					class="flex items-center justify-center w-8 h-8 rounded-lg hover:bg-sidebar-accent transition-colors"
	...
	<Sidebar.Content class="px-2">
		...
		<!-- Chat list -->
		<Sidebar.Group class="p-0">
			<Sidebar.GroupLabel class="group-data-[state=collapsed]:hidden px-3 text-xs text-sidebar-foreground/50 mb-1">
				Chats
			</Sidebar.GroupLabel>
			<Sidebar.GroupContent>
				<Sidebar.Menu>
