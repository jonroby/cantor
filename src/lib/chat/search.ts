...
export function searchChats(roots: ExchangeMap[], query: string, indices: number[]): SearchResult[] {
...
export function getDefaultItems(roots: ExchangeMap[], activeRootIndex: number, allChats: boolean): SearchResult[] {
...
export function groupResults(
    ...
    const orderedIndices = [activeRootIndex, ...roots.map((_, i) => i).filter((i) => i !== activeRootIndex)];
